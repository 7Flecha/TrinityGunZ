...
#define BULLETONWALL_COUNT	2
	...
	// Black Ops Mode
    RMesh*    m_pLeaderRedEffect;
    RMesh*    m_pLeaderBlueEffect;  
...
public:
	...
	void AddPoisonEffect(rvector& Target,int nCnt);
...
//	void AddEnchantPoison(ZObject* pObj);
	...
	void AddEnchantGold2(ZObject* pObj);
	...
	// Black Ops Mode
    void AddLeaderRedIcon(ZObject* pObj);
    void AddLeaderBlueIcon(ZObject* pObj);  

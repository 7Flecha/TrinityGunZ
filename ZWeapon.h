...
class ZWeaponMolotovGrenade : public ZMovingWeapon { 
public:
	MDeclareRTTI;

	ZWeaponMolotovGrenade() : ZMovingWeapon() { }
...
class ZWeaponIceGrenade : public ZMovingWeapon { 
public:
	MDeclareRTTI;

	ZWeaponIceGrenade() : ZMovingWeapon() { }
...
class ZWeaponFireGrenade : public ZMovingWeapon { 
public:
	MDeclareRTTI;

	ZWeaponFireGrenade() : ZMovingWeapon() { }
...
class ZWeaponPoisonGrenade : public ZMovingWeapon { 
public:
	MDeclareRTTI;

	ZWeaponPoisonGrenade() : ZMovingWeapon() { }
...
class ZWeaponLightningGrenade : public ZMovingWeapon { 
public:
	MDeclareRTTI;

	ZWeaponLightningGrenade() : ZMovingWeapon() { }

...
void ZCharacterObject::UpdateEnchant()
{
	...
	else if(etype==ZC_ENCHANT_POISON)		retype = REnchantType_Gold;
...
void ZCharacterObject::DrawEnchantSub(ZC_ENCHANT etype,rvector& pos)
{
	...
	else if(etype==ZC_ENCHANT_GOLD)
		ZGetEffectManager()->AddTrackGold( pos );
...
//	return ZC_ENCHANT_FIRE;
	...
	if(pDesc)
	{
		switch(pDesc->m_nWeaponType.Ref())
		{
			...
			case MWT_ENCHANT_GOLD: return ZC_ENCHANT_GOLD;
		}
	}

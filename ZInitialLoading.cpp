...
// Orginal Loading screen Gunz 2
		  ...
		  //follow thing
		  //DrawLight( ((int)120 + (RGetScreenWidth() - 236)/100* (mPercentage* 1.11f)), (float)(RGetScreenHeight() * 0.6197916666666667f), 
		  //		 (float)(RGetScreenWidth() * 0.0458984375), (float)(RGetScreenHeight() * 0.0455729166666667f)); 



// Orginal Loading screen Herogamers gunz
//			DrawBar( (float)(RGetScreenWidth() * 0.7735), (float)(RGetScreenHeight() * 0.9530f), 
//					 (float)(RGetScreenWidth() * 0.210), (float)(RGetScreenHeight() * 0.0135f),  mPercentage* 0.01f ); 
// falldown loading screen
/*
...
*/
		...
		if(m_pLoadingStr && mpDC ) 
		{
			...
			// follow bar..
			//int x = (int)120 + (RGetScreenWidth() - 236)/100* (mPercentage* 1.11f) - nWidth/2;
			//int y = (int)(RGetScreenHeight() * 0.6653645833333333f);

			int x = (int)(RGetScreenWidth() * 0.80078125f);
			int y = (int)(RGetScreenHeight() * 0.6380208333333333f);

...
class MBMatchAsyncDBJob_BuyVipItem : public MAsyncJob
{
public :
	MBMatchAsyncDBJob_BuyVipItem(const MUID& uidOwner) : MAsyncJob( MASYNCJOB_BUYVIPITEM, uidOwner )
	{
		m_nCID				= 0;
		m_nItemID			= 0;
		m_nItemCount		= 0;

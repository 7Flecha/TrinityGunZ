...
void ZMonsterBookInterface::DrawPage( void)
{
	...
	if ( m_nCurrentPageNum == 0)
		((MBitmapR2*)m_pBookBgImg)->Create( "monsterIllust.png", RGetDevice(), "common/interface/MonsterIllust/book_firstbg.jpg");
	else
		((MBitmapR2*)m_pBookBgImg)->Create( "monsterIllust.png", RGetDevice(), "common/interface/MonsterIllust/book_bg.jpg");
	...
	char szFileName[ 256];
	sprintf( szFileName, "common/interface/MonsterIllust/monster_Illust%02d.jpg", pPageInfo->m_nID);

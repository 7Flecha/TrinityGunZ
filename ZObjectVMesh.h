...
//	virtual void SetDrawTrackSize(int s) { m_pVMesh->SetDrawTrackSize(s); }
	...
	virtual void OnRestore() { if (m_pVMesh) m_pVMesh->OnRestore(); }
	virtual void OnInvalidate() { if(m_pVMesh) m_pVMesh->OnInvalidate(); }

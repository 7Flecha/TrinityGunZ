...
DECLARE_LISTENER(ZGetRegisterFrameListener)
DECLARE_LISTENER(ZGetRegisterOKListener)
DECLARE_LISTENER(ZGetRegisterCANCELListener)
// 로비
/*
...
DECLARE_LISTENER(ZGetStaffShopCallerButtonListener)

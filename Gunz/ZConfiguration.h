...
#define FILENAME_LOCALE		"localized/localize_english/locale.xml"
#define FILENAME_CONFIG		"config.xml"
#define FILENAME_SYSTEM		"localized/localize_english/system.xml"
#define FILENAME_GTCFG		"localized/localize_english/gametypecfg.xml"
...
#define ZTOK_EXTRA_DISPLAYFPS		"DISPLAYFPS"
#define ZTOK_EXTRA_DISPLAYHPAP		"DISPLAYHPAP"
...
#define Z_EXTRA_DISPLAYFPS		(ZGetConfiguration()->GetExtra()->bDisplayFPS)
#define Z_EXTRA_DISPLAYHPAP		(ZGetConfiguration()->GetExtra()->bDisplayHPAP)

...
class ZCharacterManagerBase : public map<MUID, ZCharacterObject*>
{
public:
	virtual ~ZCharacterManagerBase() {}

	ZCharacterObject* Find(MUID uid);
};

class ZCharacterManager : public ZCharacterManagerBase
{
private:
	int		m_nLiveCount;

...
// Sound FX
#define SOUNDEFFECT_DIR	"common/sound_bgm/effect/"
#define SOUNDEFFECT_EXT	"*.wav"
#define SOUND_OPTION_FILE_NAME	"SoundOption.xml"
#define SOUNDEFFECT_XML "common/sound_bgm/effect/effect.xml"
#define SOUNDNPC_DIR	"common/quest_mat/npc/"
...
//	if( !m_bSoundEnable ) return false;
	...
	// 가짜
	static char m_stSndFileName[MAX_BGM][64] = {"CharacterSelectSong.mp3", 
												"LobbySong.mp3", 
												"InGameNum1.mp3", 
            									"InGameNum2.mp3",
            									"InGameNum3.mp3", 

...
public:
	...
	void OnExplosionSpecialGrenade(MUID uidOwner,rvector pos,float fDamage,float fRange,float fMinDamage,float fKnockBack,MMatchTeam nTeamID, const char* pSPGrenadeType);

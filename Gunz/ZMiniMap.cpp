...
bool ZMiniMap::Create(const char *szName)
{
	...
	m_pTeamColorTexture = RCreateBaseTexture("common/Interface/Default/Combat/minimap_teamcolor.png");
	if(!m_pTeamColorTexture) return false;

	m_pPlayerTexture = RCreateBaseTexture("common/Interface/Default/Combat/minimap_player.png");

...
#ifdef LOCALE_BRAZIL
#define APPLICATION_NAME		"DevilGunz"
#elif LOCALE_BETA
#define APPLICATION_NAME		"Gunz Beta"
#else
#define APPLICATION_NAME		"DevilGunz"
#endif
...
// 저장되는 폴더
#ifdef LOCALE_BRAZIL
#define GUNZ_FOLDER			"/DevilGunz"
#elif LOCALE_BETA
#define GUNZ_FOLDER			"/Gunz Beta"
#elif LOCALE_JAPAN
#define GUNZ_FOLDER			"/DevilGunz"
#else
#define GUNZ_FOLDER			"/DevilGunz"
...
#define ZGetSGame()				(ZApplication::GetGameInterface() ? ZApplication::GetGameInterface()->GetSGame() : NULL)

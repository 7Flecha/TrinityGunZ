...
public:
	...
	bool InitAccountInfo(const char* szAccountID, MMatchUserGradeID nUGradeID, MMatchPremiumGradeID nPGradeID, int nVipCoins);
	...
	int					GetVipCoins() { return m_nVipCoins; }
	...
	bool				IsAdminGrade() {
		if ( (GetUGradeID() == MMUG_ADMINISTRATOR) || (GetUGradeID() == MMUG_DEVELOPER) || (GetUGradeID() == MMUG_OWNER) || (GetUGradeID() == MMUG_GAMEMASTER) )
			return true;
		else
			return false;
	}
	...
	void SetVipCoins(int nVipCoins)				{ m_nVipCoins = nVipCoins; }

...
void ZScreenDebugger::DrawDebugInfo(MDrawContext *pDC)
{
	...
	RDrawLine(m_debugPos, m_debugPos + rvector(100.0f,0.0f,0.0f), 0xFFFF0000);
	RDrawLine(m_debugPos, m_debugPos + rvector(0.0f,100.0f,0.0f), 0xFF00FF00);
	RDrawLine(m_debugPos, m_debugPos + rvector(0.0f,0.0f,100.0f), 0xFF0000FF);
...
{
#ifndef _PUBLISH
	char buf[256];	char buf1[256], buf2[256];	char buf1[256], buf2[256];

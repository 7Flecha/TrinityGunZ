...
{
	// 대체 언어용 UI이미지는 common/interface/###/skinname 의 폴더에 넣도록 한다
	// 예) common/interface/default, interface/lodable의 독일어용 경로는 interface/grm/default, interface/grm/lodable이 된다

...
void MMatchStageSetting::SetDefault()
{
	...
	m_StageSetting.Ref().bIsTraining = MMATCH_DEFAULT_STAGESETTING_TRAINING;
	m_StageSetting.Ref().bIsNoLead = MMATCH_DEFAULT_STAGESETTING_NOLEAD;
...
bool MMatchStageSetting::IsBountyPlay()
{
	return MGetGameTypeMgr()->IsBountyGame(m_StageSetting.Ref().nGameType);
}

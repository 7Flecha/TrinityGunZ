...
#define MMATCH_GAMETYPE_VAMPIRE_STR				"Vampire Mode"
#define MMATCH_GAMETYPE_CTF_STR					"Capture the Flag"
#define MMATCH_GAMETYPE_BOUNTY_STR				"Bounty Hunter"
...
_InitGameType(MMATCH_GAMETYPE_VAMPIRE,			MMATCH_GAMETYPE_VAMPIRE,			MMATCH_GAMETYPE_VAMPIRE_STR,		  1.0f,			0.8f,					0.3f);
_InitGameType(MMATCH_GAMETYPE_CTF,				MMATCH_GAMETYPE_CTF,				MMATCH_GAMETYPE_CTF_STR,			  1.0f,			0.6f,					0.5f);
_InitGameType(MMATCH_GAMETYPE_BOUNTY,			MMATCH_GAMETYPE_BOUNTY,				MMATCH_GAMETYPE_BOUNTY_STR,			  1.5f,			0.0f,					0.0f);
/*
#ifdef _CLASSIC

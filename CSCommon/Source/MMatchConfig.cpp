...
bool MMatchConfig::Create()
{
	...
	GetPrivateProfileString("SERVER", "MODE", SERVER_CONFIG_SERVERMODE_TEST, szServerMode, 128, SERVER_CONFIG_FILENAME);
	...
	mlog("Server Mode: %d(%s)\n", m_nServerMode, szServerMode);

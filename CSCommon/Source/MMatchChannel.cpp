...
bool MMatchChannel::Create(const MUID& uid, const char* pszName, const char* pszRuleName, 
						MCHANNEL_TYPE nType, int nMaxPlayers, int nLevelMin, int nLevelMax, const bool bIsEvent,
...
bool MMatchChannelMap::Add(const char* pszChannelName, const char* pszRuleName, MUID* pAllocUID, MCHANNEL_TYPE nType, int nMaxPlayers, int nLevelMin, int nLevelMax, const bool bIsEvent,
						   const bool bIsTicketChannel, const DWORD dwTicketItemID, const bool bIsUseTicket, const char* pszChannelNameStrResId)
{
	...
	pChannel->Create(uidChannel, pszChannelName, pszRuleName, nType, nMaxPlayers, nLevelMin, nLevelMax, bIsEvent, bIsTicketChannel, dwTicketItemID, bIsUseTicket, pszChannelNameStrResId);

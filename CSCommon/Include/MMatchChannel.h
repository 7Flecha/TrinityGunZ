...
public:
	bool Create(const MUID& uid, const char* pszName, const char* pszRuleName, 
				...
				int nLevelMin=CHANNEL_NO_LEVEL, int nLevelMax=CHANNEL_NO_LEVEL, const bool bIsEvent = false,
...
public:
	...
	bool Add(const char* pszChannelName, const char* pszRuleName, MUID* pAllocUID, MCHANNEL_TYPE nType=MCHANNEL_TYPE_PRESET, int nMaxPlayers=DEFAULT_CHANNEL_MAXPLAYERS, int nLevelMin=-1, int nLevelMax=-1, const bool bIsEvent=false,

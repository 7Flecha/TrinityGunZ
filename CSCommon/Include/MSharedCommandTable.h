...
#define MC_MATCH_LOGIN_REGISTER					1013	///< 로그인
...
#define MC_NEWQUEST_PEER_NPC_BOSS_HPAP		6406	///< 정기적으로 업데이트되는 NPC 보스 체력 아머
#define MC_NEWQUEST_ROUND_START				6407	///< 정기적으로 업데이트되는 NPC 보스 체력 아머
#define MC_NEWQUEST_PLAYER_DEAD				6408	///< 정기적으로 업데이트되는 NPC 보스 체력 아머
#define MC_NEWQUEST_REQUEST_DEAD			6409	///< 플레이어 죽었다고 요청(C -> S) 퀘스트모드에서는 MC_MATCH_GAME_KILL대신 보낸다.
...
#define MC_MATCH_PORTAL_STATE					50016	
#define MC_MATCH_PORTAL_HIT						50017	
#define MC_MATCH_REQUEST_PORTAL_HIT				50018
#define MC_MATCH_PORTAL_EFFECT					50019	

#define MC_PEER_NOLEAD_RANGE					50014
#define MC_PEER_KILLSTREAK						50015
#define MC_PEER_NOLEAD_MELEE					50020

#define MC_ADMIN_BAN							60010
#define MC_ADMIN_GRADES                         60011

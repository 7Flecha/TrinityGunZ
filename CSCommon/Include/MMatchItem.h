...
enum MMatchCustomItemType
{
	...
	MMCIT_ENCHANT_GOLD,			// 인챈트 아이템 - Gold
...
//	char					m_szItemName[128];
	...
	bool					m_bIsCashItem;		//vip shop
	bool					m_bIsStaffItem;		//staff shop
	...
	bool IsCashItem()		{ if (m_bIsCashItem) return true; return false; }	//vip shop
	bool IsStaffItem()		{ if (m_bIsStaffItem) return true; return false; } //staff shop
	bool IsEnchantItem()	{ if (m_nWeaponType.Ref() >= MWT_ENCHANT_FIRE && m_nWeaponType.Ref() <= MWT_ENCHANT_POISON) return true; return false; }

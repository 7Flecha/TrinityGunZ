...
#define MMATCH_DEFAULT_STAGESETTING_TRAINING			false
#define MMATCH_DEFAULT_STAGESETTING_NOLEAD				true
...
public:
	...
	bool						IsTraining()				{ return m_StageSetting.Ref().bIsTraining; }
	bool						IsNoLead()					{ return m_StageSetting.Ref().bIsNoLead; }

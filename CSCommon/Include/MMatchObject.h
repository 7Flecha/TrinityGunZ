...
enum MMatchUserGradeID
{
	...
	MMUG_FMOD				= 250,
	MMUG_ADMINISTRATOR		= 251,
	MMUG_DEVELOPER			= 252,	// 이벤트 진행자
	MMUG_BLOCKED			= 253,	// 사용 정지
	MMUG_GAMEMASTER			= 254,	// 개발자
	MMUG_OWNER				= 255	// 관리자
};
...
struct MMatchAccountInfo
{
	...
	MMatchAccountInfo() : m_nAID(-1), m_nUGrade(MMUG_FREE), m_nPGrade(MMPG_FREE), m_nCCode(0), m_nVipCoins(0)
	{

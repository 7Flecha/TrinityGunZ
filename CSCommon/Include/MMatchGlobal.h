...
// 각 래더타입별 필요한 인원수
const int g_nNeedLadderMemberCount[MLADDERTYPE_MAX] = {	2, 3, 4, 5, 6, 7, 8
#ifdef _DEBUG
, 1 
#endif
};
...
#define ANNOUNCE_STRING_LEN				256//64
#define MSG_STRING_LEN					256//64
#define CHAT_STRING_LEN					256//64
#define VOTE_DISCUSS_STRING_LEN			256//64
#define VOTE_ARG_STRING_LEN				256//64
// stage
#define STAGENAME_LENGTH				64	// 방이름 길이
#define STAGEPASSWD_LENGTH				8	// 패스워드 최대길이
#define STAGE_QUEST_MAX_PLAYER			8	// 퀘스트 게임모드의 최대인원
#define STAGE_CQUEST_MAX_PLAYER			8	// TEST CQ

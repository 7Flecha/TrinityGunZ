...
enum MMATCH_GAMETYPE {
	...
	// Custom
	MMATCH_GAMETYPE_VAMPIRE				=13,		///< Vampire Mode
	MMATCH_GAMETYPE_CTF					=14,		///< Capture The Flag
	MMATCH_GAMETYPE_TRAINING_TEAM		=15,		///< Team Training
	MMATCH_GAMETYPE_ESCAPE				=17,		///< Escape Mode
	MMATCH_GAMETYPE_BOUNTY				=18,		///< Bounty Hunter
/*
#ifndef _CLASSIC
...
public:
	...
	inline bool IsBountyGame(MMATCH_GAMETYPE nGameType);
	...
	inline bool IsCQuestDerived(MMATCH_GAMETYPE nGameType);	///TEST CQ
...
inline bool MBaseGameTypeCatalogue::IsBountyGame(MMATCH_GAMETYPE nGameType)
{
	// 좀더 복잡해지면 Description에 teamgame인지 여부값을 넣도록 하자.

	if (nGameType == MMATCH_GAMETYPE_BOUNTY)
	{
		return true;
	}
	return false;
...
inline bool MBaseGameTypeCatalogue::IsCQuestDerived(MMATCH_GAMETYPE nGameType)
{

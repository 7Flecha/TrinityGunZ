...
void ZWeaponMgr::AddGrenade(rvector &pos,rvector &velocity,ZObject* pC, char *szMeshName){
...
void ZWeaponMgr::AddMolotovGrenade(rvector &pos,rvector &velocity,ZObject* pC)
{
	ZWeaponMolotovGrenade* pWeapon = new ZWeaponMolotovGrenade;
...
void ZWeaponMgr::AddIceGrenade(rvector &pos,rvector &velocity,ZObject* pC)
{
	ZWeaponIceGrenade* pWeapon = new ZWeaponIceGrenade;
...
void ZWeaponMgr::AddFireGrenade(rvector &pos,rvector &velocity,ZObject* pC)
{
	ZWeaponFireGrenade* pWeapon = new ZWeaponFireGrenade;
...
void ZWeaponMgr::AddPoisonGrenade(rvector &pos,rvector &velocity,ZObject* pC)
{
	ZWeaponPoisonGrenade* pWeapon = new ZWeaponPoisonGrenade;
...
void ZWeaponMgr::AddLightningGrenade(rvector &pos,rvector &velocity,ZObject* pC)
{
	ZWeaponLightningGrenade* pWeapon = new ZWeaponLightningGrenade;

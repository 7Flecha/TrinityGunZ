...
public:
	...
	void Clear();
	void AddGrenade(rvector &pos,rvector &velocity,ZObject* pC, char *szMeshName);
	void AddMolotovGrenade(rvector &pos,rvector &velocity,ZObject* pC);
	void AddIceGrenade(rvector &pos,rvector &velocity,ZObject* pC);
	void AddFireGrenade(rvector &pos,rvector &velocity,ZObject* pC);
	void AddPoisonGrenade(rvector &pos,rvector &velocity,ZObject* pC);
	void AddLightningGrenade(rvector &pos,rvector &velocity,ZObject* pC);
